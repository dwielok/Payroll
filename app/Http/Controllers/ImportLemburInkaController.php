...
class ImportLemburInkaController extends Controller
{
    ...
    public function import(Request $request)
    {
        ...
        $file->move('importLemburInkaDoc', $nama_file);

        // Excel::import(new KaryawanTetapImport, public_path('/importTetap/' . $nama_file));
        $collection = Excel::toCollection(new KaryawanTetapImport, public_path('/importLemburInkaDoc/' . $nama_file));
