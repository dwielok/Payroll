                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 d-flex align-items-center">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">
                                <a href="/GajiLemburPkwtSuper" class="link">
                                    List Lembur Karyawan PKWT </a>
                            </li>
                            <li class="breadcrumb-item active" aria-current="page">
                                View Detail Gaji Karyawan PKWT
                            </li>
                        </ol>
                    </nav>
                    <h1 class="mb-0 fw-bold">List Detail Gaji Lembur Karyawan PKWT</h1>
                </div>
            </div>
        </div>
        <!-- ============================================================= -->
                                    ...
                                    <tbody>
                                        @foreach ($gajis as $gaji)
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        <a href="{{ url('/EditLemburPkwtSuper?id=' . $gaji->id_gaji) }}"
