    ...
    <div class="page-titles">
        <div class="row">
            <div class="col-lg-8 col-md-6 col-12 align-self-center">
                ...
                <h1 class="mb-0 fw-bold">Approval</h1>
            </div>
        </div>
    </div>
    <!-- ============================================================= -->
        ...
        <div class="row">
          ...
          ">
                            ...
                            <div class="input-group" style="position: absolute; width:20%; margin:50px">
                                ...
                                <input class="form-control border-start-0 border" type="search" value="search" id="example-search-input">
                            </div>
                                ...
                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton" style="width:300px">
                                    ...
                                    <div class="row mt-4 ps-4 pe-4 pt-4 pb-4">
                                        <div class="col-6">
                                            ...
                                            <div class="mb-3">
                                                <input type="checkbox" id="md_checkbox_{{ $loop->iteration }}" class="material-inputs filled-in chk-col-red">
                                        ...
                                        <div class="col-6">
                                            @for ($tahun = 2017; $tahun <= 2023; $tahun++) <div class="mb-3">
                                                <input type="checkbox" id="md_checkbox_{{ $tahun }}" class="material-inputs filled-in chk-col-red">
                    ...
                    <table id="zero_config" class="table table-striped table-bordered text-center ">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-{{$approval->status == 0 ? 'success' : 'danger'}}">{{$status}}</td>
                                ...
                                <td>
                                    ...
                                    <button onclick="document.getElementById('form-approve-{{$approval->id}}').submit();" type="button" @if($approval->status != null) disabled='disabled' @endif class="btn btn-navy align-items-center ms-2" >Approve</button>
                                    ...
                                    <button type="button" @if($approval->status != null) disabled='disabled' @endif class="btn btn-merah align-items-center ms-2" data-bs-toggle="modal" data-bs-target="#modalDecline" data-bs-whatever="@fat">Decline</button>
                                    <div class="modal fade" id="modalDecline" tabindex="-1" aria-labelledby="modalDeclineLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h1 class="modal-title fs-5" id="modalDeclineLabel">Keterangan Ditolak</h1>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                </div>
                                                <div class="modal-body">
