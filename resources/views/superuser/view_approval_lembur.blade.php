    ...
    <div class="container-fluid">
        ...
        <div class="row">
          ...
          ">
                            ...
                            <a href="{{ url('/ExportTetapSuper') }}" class="btn btn-navy d-flex align-items-center ms-2">
                                Export
                            </a>
                        </div> --}}
                        ...
                        <div class="d-flex align-items-center justify-content-center" style="margin-left: 55%">
                            <button onclick="document.getElementById('form-approve-{{ $approval->id }}').submit();" type="button" @if ($approval->status != null) disabled='disabled' @endif
                        ...
                        <form method="POST" action="{{ route('superuser.approval.lembur.approve') }}" id="form-approve-{{ $approval->id }}">
                            @csrf
                            @method('PATCH')
                        ...
                        <div class="modal fade" id="modalDecline" tabindex="-1" aria-labelledby="modalDeclineLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form method="POST" action="{{ route('superuser.approval.lembur.decline') }}" id="form-decline-{{ $approval->id }}">
                                            @csrf
                                            @method('PATCH')
                                            <input type="hidden" name="id" value="{{ $approval->id }}">
                                            <div class="mb-3">
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-merah" data-bs-dismiss="modal">Close</button>
