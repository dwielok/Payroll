...
<body>
    ...
    <div class="container-fluid vh-100">
        <div class="mx-auto p-2 h-100">
            <div class="w-100 text-center h-100">
                <img src="{{ asset('img/logo_baru.png') }}" alt="logo" width="200px" class="p-5">
                <div class="d-flex align-items-center justify-content-center p-2 h-75">
                    <div>
